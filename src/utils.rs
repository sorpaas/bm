...
use crate::{EmptyBackend, Construct, ValueOf, Error, Value};
...
pub fn vector_tree<DB: EmptyBackend>(values: &[ValueOf<DB::Construct>], db: &mut DB, max_len: Option<usize>) -> Result<ValueOf<DB::Construct>, Error<DB::Error>> {
